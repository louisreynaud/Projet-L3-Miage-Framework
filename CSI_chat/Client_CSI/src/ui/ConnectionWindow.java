...
public class ConnectionWindow extends Window implements ActionListener {
	...
	protected void initializeComponents() {
		...
		JButton btnConnect = new JButton("Connecte");
		...
		JLabel copyrightField = new JLabel("Copyright by ESSAKKAY Nabil");
	...
	public void actionPerformed(ActionEvent e) {
		if (checkInput())
			...
			JOptionPane.showMessageDialog(ConnectionWindow.this, "Re-enter IP address et le nb port !");
	}
		...
		Task.run(new Runnable() {
			...
			public void run() {
				try {
					...
					MessageBox.showMessageBoxInUIThread(ConnectionWindow.this, "problem: " + e.getMessage(), MessageBox.MESSAGE_ERROR);
				}
				SwingUtilities.invokeLater(new Runnable() {
					@Override
					public void run() {
