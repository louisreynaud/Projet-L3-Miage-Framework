...
public class ProfileWindow extends ProcessingWindow implements ActionListener {
	...
	protected void initializeComponents() {
		...
		statusButton = new ClickableJLabel("Changer...");
		...
		JButton btnLookGood = new JButton("C Bon ");
	...
	protected void doneBackgoundTask(ChatResult result) {
		if (result.getCode() == ChatResult.CODE_OK) {
			MessageBox.showMessageBoxInUIThread(this, "Appliqué vos changements!", MessageBox.MESSAGE_INFO);
		} else {
			MessageBox.showMessageBoxInUIThread(this, "Vous n'avez pas appliqué vos modifications!", MessageBox.MESSAGE_ERROR);
		}
		setVisible(true);
	}
}
